...
Risk.create!([
  {project_id: 1, threat_id: 1, mitigation_id: nil, riskaccept: true},
  {project_id: 2, threat_id: 1, mitigation_id: 1, riskaccept: false},
  {project_id: 3, threat_id: 1, mitigation_id: 2, riskaccept: false},
  {project_id: 4, threat_id: 1, mitigation_id: 3, riskaccept: false}
])
