...
Requirement.create!([
  ...
  {project_id: 1, threat_id: 1, solution_id: 1, riskaccept: true}
])
Solution.create!([
  ...
  {title: "Armazenar Hash", description: "Armazenar o hash da senha, e não a senha em texto plano.", cons: "O sistema terá que refazer o calculo do hash da senha toda vez que o usuário logar", usedtimes: nil, threat_id: 4}
])
Threat.create!([
